...
class BasketRowRepository extends ServiceEntityRepository
{
     ...
     */
    public function add(BasketRow $entity, bool $flush = true): void
    {
     ...
     * @throws OptimisticLockException
     */
    public function remove(BasketRow $entity, bool $flush = true): void
    {
    ...
    // /**
    //  * @return BasketRow[] Returns an array of BasketRow objects
    //  */
    /*
    ...
    */
    ...
    /*
    public function findOneBySomeField($value): ?BasketRow
    {
        return $this->createQueryBuilder('b')
            ->andWhere('b.exampleField = :val')
            ->setParameter('val', $value)
